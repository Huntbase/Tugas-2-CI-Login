    ...
    <body>
      <div class="formbg">
        <div class="formbg-inner padding-horizontal--48">
          <h1>Form Booking Layanan Grooming Hewan</h1>
          <h2 class="subjudulform">Identitas</h2>
          <form action="/FormGRController/addForm" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
          ...
          <div class="field padding-bottom--24">
            ...
            <div class="field padding-bottom--25">
              <label for="jenis_grooming">Jenis Grooming</label>
              <select name="jenis_grooming" title="jenis_grooming" id="jenis_grooming">
                <option value="Dry Grooming">Dry Grooming</option>
                <option value="Basic Grooming">Basic Grooming</option>
                <option value="Grooming Lengkap">Grooming Lengkap</option>
              </select>
            </div>
            <div class="field padding-bottom--24">
              <button type="submit">
