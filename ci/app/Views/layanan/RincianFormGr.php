<html>
    ...
    <body>
    <div class="formbg">
        <h1>Rincian Booking Grooming Hewan</h1>
        <br>
        <table align="center">
            <tr>
            ...
            <tr>
                ...
                <td align="center">:</td>
                <td><?= $formSubmission['jenis_grooming'] ?></td>
                <!-- <td>10:00</td> -->
            </tr>
        </table>
        <br>
        <table align="center">
            ...
            <tr>
                <td align="right" style="background-color: #fffcfc; padding-left: 10px;" width="532px"><?= $formSubmission['jenis_grooming'] ?></td>
