                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php foreach ($products as $products) : ?>
                                            <tr>
                                                <td><img src="<?= base_url('uploads/' . $products['image']) ?>" alt="<?= $products['name'] ?>" width="100"></td>
                                                <td><?= $products['name'] ?></td>
                                                <td>Rp. <?= number_format($products['price'], 0, ',', '.') ?></td>
                                                <td><?= $products['description'] ?></td>
                                                <td>
                                                    <a href="<?= base_url('admin/editProduct/' . $products['id']) ?>" class="btn btn-primary">Edit</a>
                                                    <form action="<?= base_url('admin/deleteProduct/' . $products['id']) ?>" method="post" style="display:inline-block;">
                                                        <?= csrf_field() ?>
