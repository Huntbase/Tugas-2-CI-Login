...
<head>
    ...
    <style>
        ...
        .max-width {
            ...
            /* Memastikan teks terputus dengan baik */
            white-space: normal;
            /* Memastikan teks dibungkus dalam kolom */
        }
    </style>
</head>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Photo</th>
                                            <th>Role</th>
                                            <th class="max-width">Reset Token</th>
                                            <th>Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($users as $users) : ?>
                                            <tr>
                                                <td class="max-width"><?= $users['username'] ?></td>
                                                <td class="max-width"><?= $users['email'] ?></td>
                                                <td class="max-width"><?= $users['password'] ?></td>
                                                <td><?= $users['name'] ?></td>
                                                <td><?= $users['photo'] ?></td>
                                                <td><?= $users['role'] ?></td>
                                                <td class="max-width"><?= $users['reset_token'] ?></td>
                                                <td>
                                                    <form action="<?= base_url('admin/deleteUser/' . $users['id']) ?>" method="post" style="display:inline-block;">
                                                        <?= csrf_field() ?>
