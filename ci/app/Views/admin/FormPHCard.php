            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Data Booking Penitipan Hewan</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Penitipan Hewan</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php foreach ($formpenitipan as $formpenitipan) : ?>
                                            <tr>
                                                <td><?= $formpenitipan['nama'] ?></td>
                                                <td><?= $formpenitipan['nomor_hp'] ?></td>
                                                <td><?= $formpenitipan['nama_hewan'] ?></td>
                                                <td><?= $formpenitipan['spesies_hewan'] ?></td>
                                                <td><?= $formpenitipan['ras_hewan'] ?></td>
                                                <td><?= $formpenitipan['jenis_kelamin_hewan'] ?></td>
                                                <td><?= $formpenitipan['tanggal_lahir_hewan'] ?></td>
                                                <td><?= $formpenitipan['berat_hewan'] ?></td>
                                                <td><?= $formpenitipan['tanggal_checkin'] ?></td>
                                                <td><?= $formpenitipan['tanggal_checkout'] ?></td>
                                                <td>
                                                    <form action="<?= base_url('admin/deletePenitipanHewan/' . $formpenitipan['id']) ?>" method="post" style="display:inline-block;">
                                                        <?= csrf_field() ?>
