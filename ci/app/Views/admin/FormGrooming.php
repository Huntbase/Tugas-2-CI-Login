      ...
      <div class="col-sm-4">
        <div class="page-header float-left">
          <div class="page-title">
            <h1>Data Booking Grooming Hewan</h1>
          </div>
        </div>
      </div>
      <div class="col-sm-8">
        <div class="page-header float-right">
          <div class="page-title">
            <ol class="breadcrumb text-right">
              ...
              <li class="active">Grooming Hewan</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <?php foreach ($formgrooming as $formgrooming) : ?>
                      <tr>
                        ...
                        <td><?= $formgrooming['jenis_kelamin'] ?></td>
                        <td><?= $formgrooming['tanggal_lahir_hewan'] ?></td>
                        ...
                        <td>
                          <form action="<?= base_url('admin/deleteGroomingHewan/' . $formgrooming['id']) ?>" method="post" style="display:inline-block;">
                            <?= csrf_field() ?>
